...
public class Rocket extends AbstractEnemy {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = 661957767449454783L;
	...
	public Rocket(float x, float y, float offsetX, float offsetY, float width, float height,
